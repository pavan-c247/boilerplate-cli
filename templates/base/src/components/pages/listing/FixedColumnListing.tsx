...
export default function FixedColumnListingPage() {
  ...
  const columns: UITableColumn<UserListItem>[] = [
    ...
    {
      key: "twoFAMethods",
      title: t("twoFAMethods"),
      dataIndex: "preferredTwoFAMethods",
      render: (methods: { methodType: string }[]) =>
        methods.length ? methods.map((m) => m.methodType).join(", ") : "-",
    },
    {
      key: "createdAt",
      title: t("createdAt"),
    ...
    },
    {
      ...
      title: t("updatedAt"),
      dataIndex: "updatedAt",
      render: (date: string) => formatDate(date),width: 150,
    },
    {
      key: "actions",
      title: t("actions"),
